...
const OrderManagement = () => {
  ...
  const updateStatus = async () => {
    try {
      const response = await axios.put(`https://ecommerce-backend-pi-three.vercel.app/api/order/orders/updateorder`, {
  ...
  const sendEmailNotification = async (order) => {
    try {
      const response = await axios.post('https://ecommerce-backend-pi-three.vercel.app/api/product/send-email', {
        to: order.email,
