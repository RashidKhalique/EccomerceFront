  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (selectedProductId) {
        await axios.put(`https://ecommerce-backend-pi-three.vercel.app/api/product/edit/${selectedProductId}`, { 
          name, 
          price, 
          imageurl, 
          discount, 
        ...
        await axios.post('https://ecommerce-backend-pi-three.vercel.app/api/product/create', { 
          name, 
          price, 
          imageurl, 
          discount, 
