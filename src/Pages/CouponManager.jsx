...
const CouponManager = () => {
  ...
  useEffect(() => {
    const fetchCoupons = async () => {
      try {
        const response = await axios.get("https://ecommerce-backend-pi-three.vercel.app/api/discount/coupon");
  ...
  const addCoupon = async (code, discountValue, expirationDate, productId) => {
    ...
    try {
      const response = await axios.post("https://ecommerce-backend-pi-three.vercel.app/api/discount/coupon", newCoupon);
  ...
  const removeCoupon = async (code) => {
    try {
      const response = await axios.delete(`https://ecommerce-backend-pi-three.vercel.app/api/discount/coupon/${code}`);
      if (response.data.success) {
