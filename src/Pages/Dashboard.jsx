...
function Dashboard() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axios.get('https://ecommerce-backend-pi-three.vercel.app/api/product/showuser');
  ...
  useEffect(() => {
    const allFetch = async () => {
      try {
        const response = await axios.get('https://ecommerce-backend-pi-three.vercel.app/api/discount/all');
  ...
  useEffect(() => {
    const weekDataFetch = async () => {
      try {
        const response = await axios.get('https://ecommerce-backend-pi-three.vercel.app/api/order/alldaysdata');
        if (response.data.success) {
