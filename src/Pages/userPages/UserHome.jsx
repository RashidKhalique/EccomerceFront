...
function UserHome() {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="flex flex-col lg:flex-row items-center justify-between bg-gray-100 px-6 py-10 lg:px-20 lg:py-16">
      ...
      {/* Promotional Section */}
      <div className="relative overflow-hidden bg-white py-16 sm:py-24 lg:py-40 px-6 sm:px-8 lg:px-16">
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-10 text-center">
            <a href="#" className="inline-flex items-center justify-center border border-transparent bg-blue-600 px-6 py-3 text-base font-medium text-white hover:bg-blue-700">
              Shop Collection
            </a>
          </div>
        </div>
